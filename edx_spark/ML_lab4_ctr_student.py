...
def oneHotEncoding(rawFeats, OHEDict, numOHEFeats):
    ...
    """
    return SparseVector(numOHEFeats,sorted([OHEDict[raw] for raw in rawFeats]),[1 for raw in rawFeats])
...
# TODO: Replace <FILL IN> with appropriate code
sampleOHEData =sampleDataRDD.map(lambda sample:oneHotEncoding(sample,sampleOHEDictManual,len(sampleOHEDictManual)))
